...
<div class="secondary-bg" id="sidebar-wrapper">
    <div class="sidebar-heading text-center py-4 primary-text-color fs-4 fw-bold text-uppercase border-bottom">Welcome Back</div>
    <div class="list-group list-group-flush my-3">
        ...
        <button type="button" id="btnDash" onclick="loadDashboard()" class=" list-group-item list-group-item-action bg-transparent second-text-color active">
            <i class="fas fa-tachometer-alt me-2"></i>Dashboard
        </button>
        <button type="button" id="btnBook" onclick="loadBooks()" class=" list-group-item list-group-item-action bg-transparent second-text-color ">
            <i  class="fas fa-book me-2"></i>Books
        </button>

        <button type="button" id="btnprfl" onclick="loadProfile()" class=" list-group-item list-group-item-action bg-transparent second-text-color ">
